...
<template>
  <div
    v-editable="blok"
    :class="`serviceCard max-w-[600px] w-full p-[50px] rounded-[45px] border border-dark ${
      blok.background == 'gray'
        ? 'bg-grey'
  ...
  >
    <div class="flex space-x-16 items-center">
      <div class="space-y-24">
        <h3
          :class="`bg-green px-0.5 text-3xl leading-7 max-w-[213px] ${
            blok.background == 'gray'
              ? 'bg-green'
              : blok.background == 'green'
              ? 'bg-grey'
        ...
        <a
          :class="`text-xl leading-7 flex items-center space-x-3.5 ${
